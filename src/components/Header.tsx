    ...
    >
      <div className="container-px mx-auto flex h-[83px] max-w-[1760px] items-center justify-between">
        ...
        <div className="hidden items-center gap-3 xl:flex">
          ...
          <Link
            href="/contact"
            className={`rounded-lg px-5 py-2.5 text-[14px] font-semibold transition-colors duration-300 ease-out hover:bg-brand-hover hover:text-ink ${
      ...
      {open && (
        <div className="border-t border-line bg-paper xl:hidden">
          <nav className="container-px mx-auto flex max-w-[1760px] flex-col py-3">
            ...
            <Link
              href="/contact"
              className="mt-4 rounded-lg bg-ink px-4 py-3 text-center text-sm font-semibold text-white transition-colors duration-300 ease-out hover:bg-brand-hover hover:text-ink"
            >
              Request a call back
            </Link>
          </nav>
