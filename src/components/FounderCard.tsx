              ...
              <div className="mt-1 flex items-center gap-2.5">
                ...
                {founder.linkedin && (
                  <a
                    ...
                    className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-brand-tint text-brand-dark transition-colors hover:bg-brand-strong hover:text-white"
                  >
                    <LinkedInIcon />
                  </a>
                )}
